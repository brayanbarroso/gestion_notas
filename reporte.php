<?php 
   ...
   class MYPDF extends TCPDF {
	...
	$pdf->SetSubject('Factura Impuesto Predial');
    $pdf->SetKeywords('Predial, San Antero, Alcaldia San Antero, Factura, Impuesto');//Palabras Claves
	...
	$cod = $_REQUEST['cod'];
     ...
     $sql = "SELECT asignatura.`Codigo`,asignatura.`Nombre`,nota.`Nota_1`,nota.`Nota_2`,nota.`Nota_3`,nota.`Definitiva`
	...
	';
        ...
        //<p><em>"Por el sentir de un pueblo, paz y equidad social"</em></p>	
