...
<nav class="navbar navbar-inverse" role="navigation">
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
	    <ul class="nav navbar-nav">
	      <li><a href="index.php?cod=<?php echo base64_encode($_SESSION['user']); ?>">Inicio</a></li>
	    </ul>

	    <ul class="nav navbar-nav navbar-right">
            
        	<li class="dropdown">
	          	<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><strong style="color: #fff"><?php echo $_SESSION['user_nombre']; ?> <?php echo $_SESSION['user_apellido']; ?></strong><span class="caret"></span></a>
